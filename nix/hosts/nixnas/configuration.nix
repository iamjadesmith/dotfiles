...

{
  ...
  users.users.joejad = {
    ...
    openssh.authorizedKeys.keys = [
      ...
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIBmKPEE6+43V/dXTUqpSr7dskQus+vJH7iNJLrakcNP3 joejad@joejadserver"
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIAdXSftkwWDKSrWuWqqxTVSjUkdEhGfVbfkTLgyO2eZi root@test"
    ];
  };
